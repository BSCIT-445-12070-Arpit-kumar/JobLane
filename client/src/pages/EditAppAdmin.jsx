...
export const EditAppAdmin = () => {
    ...
    const applicantResumeUrl = applicationData?.applicantResume?.downloadUrl || applicationData?.applicantResume?.url || applicationData?.applicant?.resume?.downloadUrl || applicationData?.applicant?.resume?.url || ""
                            ...
                            <div className='pt-4 pb-6'>
                                ...
                                <div>
                                    <ul>
                                        ...
                                        <li className='flex gap-4 items-center'>Resume: {applicantResumeUrl ? <a href={applicantResumeUrl} target="_blank"
                                            rel="noreferrer" className='text-blue-500 underline cursor-pointer'>{applicationData.applicant.name} resume</a> : <span>No resume available</span>}</li>
                                    </ul>
                                </div>
