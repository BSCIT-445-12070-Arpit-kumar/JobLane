  ...
  const resumeChange = (e) => {
    ...
    const editHandler = (e) => {
        ...
        if(skills.constructor !== Array){
             skillArr = skills.split(",").map((skill) => skill.trim()).filter(Boolean)
        }
         ...
         // Only include resume for non-recruiters
         if(me.role !== "recruiter" && resume) {
                            ...
                            <form onSubmit={editHandler} className='flex flex-col md:w-1/3 shadow-gray-700  w-full md:mx-0 mx-3 pb-28' action="">
                                ...
                                <div className='md:px-10 px-7 pb-6 w-full shadow-sm shadow-gray-700 border-gray-700 border pt-5  flex flex-col gap-4'>
                                    ...
                                    <div className='bg-white flex justify-center items-center'>
                                        ...
                                        <input value={name} onChange={(e) => setName(removeDigits(e.target.value))} required placeholder='Full name' type="text" className='outline-none bold-placeholder w-full text-black px-1 pr-3 py-2' />
                                    </div>
                                    ...
                                    {me.role !== "recruiter" && <div>
                                        <div className='bg-white flex justify-center items-center'>
                                            ...
                                            <input
                                                ...
                                                placeholder='Resume' id='resume' name='resume' accept=".pdf,application/pdf" type="file" className='outline-none hidden w-full text-black px-1 pr-3 py-2' />
                                        </div>
                                    ...
                                    <div className='bg-white flex justify-center items-center'>
                                        ...
                                        <textarea value={skills} onChange={(e) => setSkills(removeDigits(e.target.value))} placeholder='Skills' type="text" className='outline-none w-full text-black bold-placeholder px-1 pr-3 py-2' />
                                    </div>
