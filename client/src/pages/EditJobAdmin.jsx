...
export const EditJobAdmin = () => {
    ...
    const updateJobHandler = async () => {
        ...
        if(typeof(skillsRequired) === "string"){
            skillsArr = skillsRequired.split(",").map((skill) => skill.trim()).filter(Boolean) ;
        }
        ...
        const result = await dispatch(updateJobData(id,updatedData))
                                    ...
                                    <div className='flex flex-col w-full justify-start items-start pt-4 gap-3'>
                                        ...
                                        <div className='flex gap-3 pt-3'>
                                            ...
                                            <div className='bg-white flex justify-center items-center'>
                                                ...
                                                <input
                                                    value={title} onChange={(e) => setTitle(removeDigits(e.target.value))}
                                            ...
                                            <div className='bg-white flex justify-center items-center'>
                                                ...
                                                <input
                                                    value={companyName} onChange={(e) => setCompanyName(removeDigits(e.target.value))}
                                        ...
                                        <div className='flex gap-3'>
                                            ...
                                            <div className='bg-white flex justify-center items-center'>
                                                ...
                                                <input
                                                    value={experience} onChange={(e) => setExperience(digitsOnly(e.target.value))}
                                            ...
                                            <div className='bg-white flex justify-center items-center'>
                                                ...
                                                <input
                                                    value={location} onChange={(e) => setLocation(removeDigits(e.target.value))}
                                            ...
                                            <div className='bg-white flex justify-center items-center'>
                                                ...
                                                <input
                                                    value={salary} onChange={(e) => setSalary(digitsOnly(e.target.value))}
                                                    required placeholder='Salary (e.g. 12 for 12 LPA)' type="text" className='outline-none bold-placeholder w-full text-black px-1 pr-3 py-2' />
                                            </div>
                                        </div>
                                        ...
                                        <div className='flex gap-3 w-[48rem]'>
                                            ...
                                            <div className='bg-white w-full flex justify-center items-center'>
                                                ...
                                                <textarea
                                                    value={skillsRequired} onChange={(e) => setSkillsRequired(removeDigits(e.target.value))}
