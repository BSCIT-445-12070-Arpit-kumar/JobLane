...
export const createJobPost = (jobData) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.post(`${API_BASE_URL}/api/v1/create/job`, jobData, config) ;
...
export const getAllJobs = () => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get(`${API_BASE_URL}/api/v1/jobs`) ;
...
export const getMyJobs = () => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get(`${API_BASE_URL}/api/v1/myJobs`, config) ;
...
export const saveJob = (id) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get(`${API_BASE_URL}/api/v1/saveJob/${id}`,config) ;
...
export const getSavedJobs = () => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get(`${API_BASE_URL}/api/v1/getSavedJobs`,config) ;
