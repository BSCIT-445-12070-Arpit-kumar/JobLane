...
import { logOrNot, me as meAction } from './actions/UserActions'
...
function App() {
  ...
  const { isLogin, loading: userLoading, me } = useSelector(state => state.user)
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path='/login/applicant' element={<Login />} />
        <Route path='/login/admin' element={<Navigate to="/login/choice" replace />} />
        <Route path='/login/recruiter' element={<RecruiterLogin />} />
        <Route path='/register' element={<Register />} />
        <Route path='/register/recruiter' element={<RecruiterRegister />} />
        <Route path='/details/:id' element={<JobDetails />} />

        <Route element={<ProtectedRoute isAllowed={['applicant', 'recruiter', 'admin'].includes(role)} />}>
        ...
        <Route element={<ProtectedRoute isAllowed={role === 'applicant'} />}>
          <Route path='/Application/:id' element={<Application />} />
        </Route>

        <Route element={<ProtectedRoute isAllowed={['admin', 'recruiter'].includes(role)} />}>
        ...
        <Route element={<ProtectedRoute isAllowed={role === 'recruiter'} />}>
